...
public enum E01MediaEncodingProfile {
    public static func ffmpegJPEGArguments(imagePath: String, jpegPath: String) -> [String] {
        [
            "-y", "-nostdin", "-loglevel", "error",
            "-i", imagePath,
            "-frames:v", "1", "-vf", "scale=368:368:force_original_aspect_ratio=disable,setsar=1",
